    ...
    return (
      <>
        <div testid="countryWideConfirmedCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dchnwawe9/image/upload/v1648704057/Group_ikrkhu.png"
        ...
        <div testid="countryWideActiveCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dchnwawe9/image/upload/v1648706201/protection_1_l8znrg.png"
            className="stats-icon"
        ...
        <div testid="countryWideRecoveredCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dchnwawe9/image/upload/v1648705970/Vector_2_dyez2s.png"
            className="stats-icon"
        ...
        <div testid="countryWideDeceasedCases" className="stats-block-column ">
          ...
          <img
            src="https://res.cloudinary.com/dchnwawe9/image/upload/v1637817600/Corona_Virus_Symptoms_Shortness_of_breath_x3v5kn.png"
            className="stats-icon"
