...
class StateTotalData extends Component {
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dchnwawe9/image/upload/v1648704057/Group_ikrkhu.png',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dchnwawe9/image/upload/v1648706201/protection_1_l8znrg.png',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dchnwawe9/image/upload/v1648705970/Vector_2_dyez2s.png',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dchnwawe9/image/upload/v1637817600/Corona_Virus_Symptoms_Shortness_of_breath_x3v5kn.png',
      value: totalDeceased,
    }
